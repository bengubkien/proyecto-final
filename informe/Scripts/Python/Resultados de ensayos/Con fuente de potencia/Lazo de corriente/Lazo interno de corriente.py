...
plt.plot(t_sim, escalon_positivo_sim[298801:311500], color='black', linestyle='dashed',  linewidth=0.4)
...
plt.plot(t_sim, escalon_negativo_sim[299101:311800], color='black', linestyle='dashed', linewidth=0.6)
plt.ylabel('Corriente [A]')
plt.xlabel('Tiempo [ms]')
plt.grid(True, ls="-", linewidth=0.4)
plt.legend(['Ensayo', 'Simulación'])
