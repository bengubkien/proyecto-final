...
# Tensiones con saltos de tensión en el banco

fig, (ax1, ax2) = plt.subplots(2)
fig.suptitle('Tensiones con saltos de tensión en el banco', x=0.5, y=0.96)
...
plt.savefig('Tensiones con saltos de tensión en el banco.pdf')

# Corrientes con saltos de tensión en el banco

fig, (ax1, ax2) = plt.subplots(2)
fig.suptitle('Corrientes con saltos de tensión en el banco', x=0.5, y=0.96)
...
plt.savefig('Corrientes con saltos de tensión en el banco.pdf')